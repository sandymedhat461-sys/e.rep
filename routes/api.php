...
Route::prefix('auth')->group(function () {
    ...
    Route::post('/rep/forgot-password', [MedicalRepAuthController::class, 'forgotPassword']);
    Route::post('/rep/reset-password', [MedicalRepAuthController::class, 'resetPassword']);
